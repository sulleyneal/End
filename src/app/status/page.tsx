...
const DONE = [
  ...
  "Session recaps, written automatically once the table has been quiet for six hours",
  "Levelling from XP: hit points, hit dice, spell slots and Ability Score Improvements",
